...
function titleCase(Name) {
    ...
    var TitleCase = Name
        .split(' ')
        .map(function (words) { return words.charAt(0).toUpperCase() + words.slice(1).toLowerCase(); })
        .join(' ');
...
for (var i_2 = 0; i_2 < Names.length; i_2++) {
    console.log(Names[i_2], "Good Evening");
}
...
console.log(Names);
for (var i_3 = 0; i_3 < transportation.length; i_3++) {
    // console.log(Names[i],"Good Evening");
    if (transportation[i_3] == "BMW") {
        console.log(transportation[i_3], "i like BMW");
    }
    else if (transportation[i_3] == "YBR") {
        console.log(transportation[i_3], "fav bike");
    }
    else if (transportation[i_3] == "Heavy Bike") {
        console.log(transportation[i_3], "Most fav bike");
    }
}
...
for (var i_4 = 0; i_4 < Guest.length; i_4++) {
    // console.log(Names[i],"Good Evening");
    if (Guest[i_4] == "Javeria") {
        console.log(Guest[i_4], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_4] == "Talha") {
        console.log(Guest[i_4], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_4] == "Hannan") {
        console.log(Guest[i_4], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_4] == "Faiza") {
        console.log(Guest[i_4], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
}
...
for (var i_5 = 0; i_5 < Guest.length; i_5++) {
    // console.log(Names[i],"Good Evening");
    if (Guest[i_5] == "Javeria") {
        console.log(Guest[i_5], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_5] == "Talha") {
        console.log(Guest[i_5], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_5] == "Hannan") {
        console.log(Guest[i_5], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_5] == "Faiza") {
        console.log(Guest[i_5], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_5] == "Waleed") {
        console.log(Guest[i_5], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_5] == "Afridi") {
        console.log(Guest[i_5], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_5] == "Razaq") {
        console.log(Guest[i_5], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
}
console.log("Sidra cannot join us in the party");
...
for (var i_6 = 0; i_6 < Guest.length; i_6++) {
    if (Guest[i_6] == "Javeria") {
        console.log(Guest[i_6], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_6] == "Talha") {
        console.log(Guest[i_6], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_6] == "Hannan") {
        console.log(Guest[i_6], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_6] == "Faiza") {
        console.log(Guest[i_6], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_6] == "Waleed") {
        console.log(Guest[i_6], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
    else if (Guest[i_6] == "Afridi") {
        console.log(Guest[i_6], "Hi i hope you are doing well, i am very excited to invite you ion my Company party");
    }
}
console.log("Sidra cannot join us in the party");
...
for (var i_7 = 0; i_7 < Guest1.length; i_7++) {
    console.log(Guest1[i_7], "You are still invited");
}
...
for (var i_8 = 0; i_8 <= Guest1.length; i_8++) {
    Guest1.pop();
}
console.log(Guest1);
...
var copyArray = __spreadArray([], favLocations, true); // it will make an copy of array favlocations
copyArray.sort();
...
var copyArray1 = __spreadArray([], favLocations, true); // it will make an copy of array favlocations
copyArray1.reverse();
...
var Maxpeople = 0;
for (var i_9 = 0; i_9 < Dinner.length; i_9++) {
    Maxpeople = Maxpeople + i_9;
}
...
console.log(".............");
var Arr_1 = Arr.map(function (items, index) {
...
var color = alien_color.includes("green");
if (color) {
...
var color2 = alien_color2.includes("Green");
if (color2) {
...
for (var i_10 = 0; i_10 < alien_color3.length; i_10++) {
    if (alien_color3[i_10] == "green") {
        console.log(alien_color3[i_10], "So, player earned 5 points.");
        //b. If the alien is yellow, print a message that the player earned 10 points.
    }
    else if (alien_color3[i_10] == "yellow") {
        console.log(alien_color3[i_10], "So,player earned 10 points.");
        //c. If the alien is red, print a message that the player earned 15 points.
    }
    else if (alien_color3[i_10] == "red") {
        console.log(alien_color3[i_10], "So,player earned 15 points.");
    }
}
...
console.log(".........******");
// by using for loop
for (var i_11 = 0; i_11 < usernames.length; i_11++) {
    if (usernames[i_11] == "admin") {
        console.log("HELLO ", usernames[i_11], "would you like to see a status report?");
    }
    else {
        console.log("Hello", usernames[i_11], "thank you for logging in again.");
    }
}
...
for (var i_12 = 0; i_12 < ordinalNum.length; i_12++) {
    if (ordinalNum[i_12] == 1) {
        console.log(ordinalNum[i_12]);
    }
    else if (ordinalNum[i_12] == 2) {
        console.log(ordinalNum[i_12]);
    }
    else if (ordinalNum[i_12] == 3) {
        console.log(ordinalNum[i_12]);
    }
    else {
        console.log(ordinalNum[i_12] + "th");
    }
}
// 34. Pizzas: Think of at least three kinds of your favorite pizza. Store these pizza names in a array, and then use a for loop to print the name of each pizza.
var pizzas = ["chicken fajita", "behari kabbab", "malai boti"];
for (var i_13 = 0; i_13 < pizzas.length; i_13++) {
    console.log(pizzas[i_13]);
}
...
var pizzas = ["chicken fajita", "behari kabbab", "malai boti"];
for (var i_14 = 0; i_14 < pizzas.length; i_14++) {
    console.log("i like", pizzas[i_14], "pizza");
}
...
for (var i_15 = 0; i_15 < animals.length; i_15++) {
    console.log("A", animals[i_15], " would make a great pet");
}
...
function make_shirt2(size, message) {
    ...
    console.log("Your size of T-shirt is ".concat(size, " and printed text is \"").concat(message, "\""));
}
make_shirt2();
make_shirt2("Medium");
...
function make_new_album(songs) {
    ...
    songs.push.apply(songs, new_album.songs);
...
function show_magicians(magician) {
    for (var i_16 = 0; i_16 < magician.length; i_16++) {
        console.log(magician[i_16]);
    }
}
...
function make_great(magician) {
    for (var i_17 = 0; i_17 < magician_names.length; i_17++) {
        console.log(magician + magician_names[i_17]);
    }
}
make_great("Great ");
...
function make_great1(magician) {
    if (magician === void 0) { magician = "Great"; }
    console.log("magician name with great ");
    for (var i_18 = 0; i_18 < magician_names.length; i_18++) {
        console.log(magician + magician_names[i_18]);
    }
    console.log("origional magician name");
    var copy_magician_name = __spreadArray([], magician_names, true);
...
function sandwich_order(items) {
    ...
    for (var i_19 = 0; i_19 < items.length; i_19++) {
        console.log(items[i_19]);
    }
}
...
function Cars1(company, model) {
    if (company === void 0) { company = "Honda"; }
    if (model === void 0) { model = 2024; }
    var args = [];
    ...
    for (var i_20 = 0; i_20 < args.length; i_20 += 2) {
        var name_1 = args[i_20];
        var value = args[i_20 + 1];
        car_object[name_1] = value;
    }
